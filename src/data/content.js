export const serviceCategories = [
  ...
  },
  {
    ...
    items: [
      { title: 'Celebrity Management', text: 'Artist bookings, contracts, and backstage coordination for star appearances.' },
      { title: 'Entertainment Management', text: 'Full entertainment programming from welcome to afterparty.' },
      { title: 'DJ / Music / RJ Services', text: 'Sound design, live mixing, and hosted audio experiences.' },
      { title: 'Traditional Drums & Vadhyam', text: 'Nadaswaram, melam, and classical welcome ensembles.' },
      { title: 'Tent & Rental Services', text: 'Marquees, shamianas, and weather-ready outdoor structures.' },
      { title: 'Furniture Arrangements', text: 'Premium seating, lounge setups, and banquet furniture styling.' },
      { title: 'Vehicle & Travel Management', text: 'Guest transport, bridal cars, and convoy logistics.' },
...
export const packages = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'DJ / Music / RJ Services',
      'Special Entry Concepts & Event Hosting',
      'Traditional Drums & Vadhyam',
      'Tent, Furniture & Vehicle Management',
      'Luxury Stage Decoration',
    ],
